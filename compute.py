...
# ===============================================================
# Global State and Initialization Controls
# ===============================================================
...
_INIT_TIMESTAMP = datetime.datetime.now().isoformat()
_INIT_CALLER_INFO = []
...
async def test_telegram_connection(config, logger):
    ...
    try:
        ...
        test_message = "🔍 Test Message - Candlestick Pattern Bot connection test successful!"
    ...
    try:
        ...
        if config.get('ENABLE_TELEGRAM_ALERTS', False):
            ...
            try:
                ...
                test_message = "🔍 Test Message - Bot connection test"
        ...
        if config.get('RUN_ON_STARTUP', True):
            ...
            try:
                ...
                await asyncio.wait_for(analysis_task, timeout=300.0)  # Allow up to 5 minutes for analysis
                logger.info(f"[RUN:{run_id}] Initial analysis completed successfully")
            except asyncio.TimeoutError:
                logger.error(f"[RUN:{run_id}] Initial analysis timed out after 300 seconds")
            except Exception as e:
...
def main(config=None):
    ...
    try:
        ...
        config['STARTUP_TIME'] = "2025-05-02 15:06:45"  # Using the time you provided
